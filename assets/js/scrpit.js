...
function handleSubmit(event){
    ...
    const loseWeight = Math.round(maintenance - 450);
    const geinWeight = Math.round(maintenance + 450);
    ...
    <div class="result-content">
      <ul>
        ...
        <li>
          Para ganhar peso você precisa consumir em média <strong>${geinWeight} calorias</strong>.
        </li>
      </ul>
    </div>
    `;

    const result = doucment.getElementById('result');
